...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/perl5/5.8.8/i486-linux-thread-multi',
    ...
    exe_ext => '',
    inc_version_list => '5.8.7 5.8.6 5.8.5 5.8.4 5.8.3 5.8.2 5.8.1 5.8.0',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/lib/perl5/site_perl/5.8.8/i486-linux-thread-multi',
